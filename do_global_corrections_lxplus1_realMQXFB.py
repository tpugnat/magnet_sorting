...
if FLAG_WITH_calibration:
    NAME_SAVEFILE_FORMAT = f"{TYPE_SCORE}_dist_r{AMP_MEAS_ERROR}u_{TYPE_RAND}_c{AMP_CALI_ERROR}u_p{AMP_PRES_ERROR}u_nbsimu{MAX_SIMS}_wcor_REALVALUESQ2_Phase{STAGE}"
else:
    NAME_SAVEFILE_FORMAT = f"{TYPE_SCORE}_dist_r{AMP_MEAS_ERROR}u_{TYPE_RAND}_c{AMP_CALI_ERROR}u_p{AMP_PRES_ERROR}u_nbsimu{MAX_SIMS}_REALVALUESQ2_Phase{STAGE}"
